                ...
                <div className="video-container">
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="post-card video-post">
                                <div className="post-thumb">
                                    <img src="/assets/img/post/video-post-6.jpg" alt="video" />
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="post-card video-post">
                                <div className="post-thumb">
                                    <img src="/assets/img/post/video-post-7.jpg" alt="video" />
                                    <div className="video-btn">
                                        <a className="video-popup" onClick={() => setOpen(true)}><i className="las la-play" />
											</a>
                                    </div>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="post-card video-post">
                                <div className="post-thumb">
                                    <img src="/assets/img/post/video-post-8.jpg" alt="video" />
                                    <div className="video-btn">
                                        <a className="video-popup" onClick={() => setOpen(true)}><i className="las la-play" />
											</a>
                                    </div>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="post-card video-post">
                                <div className="post-thumb">
                                    <img src="/assets/img/post/video-post-9.jpg" alt="video" />
                                    <div className="video-btn">
                                        <a className="video-popup" onClick={() => setOpen(true)}><i className="las la-play" />
											</a>
                                    </div>
