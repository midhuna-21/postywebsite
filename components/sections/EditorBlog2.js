...
export default function EditorBlog2() {
    return (
        <>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="post-card travel-card">
                                            <div className="post-thumb">
                                                <Link href="/single-post-1"><img src="/assets/img/post/travel-post-6.jpg" alt="post" /></Link>
                                            </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="post-card travel-card-2">
                                            ...
                                            <div className="post-thumb">
                                                <Link href="/single-post-1"><img src="/assets/img/post/travel-post-7.jpg" alt="post" /></Link>
                                            </div>
                                        </div>
                                        <div className="post-card travel-card-2">
                                            <div className="post-content">
                                            ...
                                            <div className="post-thumb">
                                                <Link href="/single-post-1"><img src="/assets/img/post/travel-post-8.jpg" alt="post" /></Link>
                                            </div>
                                        </div>
                                        <div className="post-card travel-card-2">
                                            <div className="post-content">
                                            ...
                                            <div className="post-thumb">
                                                <Link href="/single-post-1"><img src="/assets/img/post/travel-post-9.jpg" alt="post" /></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
