...
export default function FashionBlog5() {
    return (
        <>
                ...
                <div className="container">
                    <div className="top-area mb-40 title-border">
                        <div className="section-heading">
                            <h3 className="section-title"><span className="bg-grey-2">Editor's Choice</span></h3>
                        </div>
                    ...
                    <div className="row justify-content-center fashion-blog-top">
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/graphic-1.jpg" alt="post" /></Link>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/graphic-2.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/graphic-3.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/graphic-4.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/graphic-5.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/graphic-6.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
