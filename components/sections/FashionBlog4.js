...
export default function FashionBlog4() {
    return (
        <>
                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center fashion-blog-top">
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/popular-post-1.jpg" alt="post" /></Link>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/popular-post-2.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/popular-post-3.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/popular-post-4.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/popular-post-5.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/popular-post-6.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
