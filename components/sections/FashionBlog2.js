...
export default function FashionBlog2() {
    return (
        <>
                ...
                <div className="container">
                    <div className="top-area mb-40 title-border">
                        <div className="section-heading">
                            <h3 className="section-title"><span className="bg-grey-2">Editors Pick</span></h3>
                        </div>
                    ...
                    <div className="row justify-content-center fashion-blog-top">
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/fasion-post-7.jpg" alt="post" /></Link>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/fasion-post-8.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/fasion-post-9.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/fasion-post-11.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/fasion-post-12.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="post-card">
                                <div className="post-thumb">
                                    <Link href="/single-post-1"><img src="/assets/img/post/fasion-post-13.jpg" alt="post" /></Link>
                                </div>
                                <div className="post-content">
